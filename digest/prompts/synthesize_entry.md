...
{{
  "headline": "<=12 words, factual, no puns, no colons-as-cleverness",
...
Questions are posed, not answered. They are what the item genuinely leaves open. Give
none rather than a filler question.
...
- Numbers phrased the way a person says them: "about a third", "twelve billion
  dollars", "roughly one in five".
- Only what the titles and blurbs support. Do not invent detail.
